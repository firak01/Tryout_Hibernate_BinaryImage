 ...
 *
 */
public class TryoutHexCellGenerateByByteArrayMain {
	...
	public static void main(String[] args) {
		...
		TryoutHexCellGenerateByByteArrayMain tryout = new TryoutHexCellGenerateByByteArrayMain();
		tryout.start();
		
		
	}
	
	public TryoutHexCellGenerateByByteArrayMain() {		
	}
	public void start() {
...
//				objCellTemp.setImage01(imageBlob);
				...
				objCellTemp.setImage01Length(lngFileLength);
